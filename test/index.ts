...
import markdownItRegex, { coreRuler, rendererRule } from "../src/index";
...
assert(
  mdi.render("I :heart: you").trim() ===
    '<p>I <i class="e1a-heart"></i> you</p>',
);
assert(
  mdi.render("I :heart: :heart: :heart: you").trim() ===
    '<p>I <i class="e1a-heart"></i> <i class="e1a-heart"></i> <i class="e1a-heart"></i> you</p>',
);

assert(
  mdi.render("A :fa-truck: runs").trim() ===
    '<p>A <i class="fa fa-truck"></i> runs</p>',
);
